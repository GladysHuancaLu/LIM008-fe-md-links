...
exports.validateAndStats = exports.validateBroken = exports.linkStats = exports.linksValidate = void 0;
...
const fetch = require('node-fetch'); // console.log(getMdFiles('./test'));
...
const validateBroken = arrLinks => arrLinks.filter(link => parseInt(link.status) === 404).length;

exports.validateBroken = validateBroken;
