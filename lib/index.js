...
console.log((0, _getAllMds.getLinksMd)((0, _getAllMds.getMdFiles)('./test')));
...
linksValidate((0, _getAllMds.getLinksMd)((0, _getAllMds.getMdFiles)('./test'))).then(res => console.log(res)); // console.log(linksValidate((getLinksMd(getMdFiles('./test')))));
// console.log(process.argv);

console.log(validateAndStats((0, _getAllMds.getLinksMd)((0, _getAllMds.getMdFiles)('./test'))));